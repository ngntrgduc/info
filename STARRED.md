...
| **[Raphire/Win11Debloat](https://github.com/Raphire/Win11Debloat)** \| ⭐ *14.6K* | A simple, easy to use PowerShell script to remove pre-installed apps from Windows, disable telemetry, remove Bing from Windows search as well as perform various other changes to declutter and improve your Windows experience. This script works for both Windows 10 and Windows 11.
...
| **[yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp)** \| ⭐ *92.4K* | A feature-rich command-line audio/video downloader
| **[astral-sh/uv](https://github.com/astral-sh/uv)** \| ⭐ *30.8K* | An extremely fast Python package and project manager, written in Rust.
...
| **[mlabonne/llm-course](https://github.com/mlabonne/llm-course)** \| ⭐ *39.9K* | Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
| **[dangeng/visual_anagrams](https://github.com/dangeng/visual_anagrams)** \| ⭐ *884* | Code for the paper "Visual Anagrams: Generating Multi-View Optical Illusions with Diffusion Models"
| **[firefly-iii/firefly-iii](https://github.com/firefly-iii/firefly-iii)** \| ⭐ *16.5K* | Firefly III: a personal finances manager
| **[yandexdataschool/nlp_course](https://github.com/yandexdataschool/nlp_course)** \| ⭐ *9.8K* | YSDA course in Natural Language Processing
| **[poloclub/awesome-grad-school](https://github.com/poloclub/awesome-grad-school)** \| ⭐ *333* | 🎓 Advice and resources for thriving and surviving graduate school
...
| **[ollama/ollama](https://github.com/ollama/ollama)** \| ⭐ *101.9K* | Get up and running with Llama 3.3, Mistral, Gemma 2, and other large language models.
...
| **[typst/typst](https://github.com/typst/typst)** \| ⭐ *35.9K* | A new markup-based typesetting system that is powerful and easy to learn.
...
| **[astral-sh/ruff](https://github.com/astral-sh/ruff)** \| ⭐ *33.6K* | An extremely fast Python linter and code formatter, written in Rust.
...
| **[jgm/pandoc](https://github.com/jgm/pandoc)** \| ⭐ *35.0K* | Universal markup converter
