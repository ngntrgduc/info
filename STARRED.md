...
| **[yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp)** \| ⭐ *99.0K* | A feature-rich command-line audio/video downloader
| **[astral-sh/uv](https://github.com/astral-sh/uv)** \| ⭐ *38.1K* | An extremely fast Python package and project manager, written in Rust.
...
| **[mlabonne/llm-course](https://github.com/mlabonne/llm-course)** \| ⭐ *45.2K* | Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
...
| **[ollama/ollama](https://github.com/ollama/ollama)** \| ⭐ *118.5K* | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
...
| **[google-research/arxiv-latex-cleaner](https://github.com/google-research/arxiv-latex-cleaner)** \| ⭐ *5.7K* | arXiv LaTeX Cleaner: Easily clean the LaTeX code of your paper to submit to arXiv
